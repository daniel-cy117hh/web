...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    ...
    Me encanta tu nombre, me encanta tu bella sonrisa, me encanta como transformas un pesimo día mio en uno radiante y lleno de alegria.\n
    Solo tu puedes robarme mi tiempo, mis miradas, mis pensamientos y mi corazón total mi corazón ya es mas tuyo que mío.\n
    Te amo mucho amor mío, aunque estemos en una situación complicada quiero que nunca pase por tu cabecita la idea de que te deje de querer porque YO SIEMPRE TE AMARÉ Y SIEMPRE DESEARÉ ESTAR A TU LADO.`;
  } else {
...
function showCountdown() {
  ...
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-05-21T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      ...
      `Volvere a verte dentro: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
